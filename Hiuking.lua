...
Sea = World1 or World2 or World3 or plr:Kick("âŒ Error : A[12]Blox Fruits âŒ")
...
spawn(function()
  while task.wait() do
    ...
    Test.Name = "highlight"
    Test.Enabled = true
    Test.FillColor = Color3.fromRGB(0, 191, 255) -- xanh nÆ°á»›c biá»ƒn
...
elseif a>=2575 and a<=2599 then -- CHá»ˆ Tá»I 2599, Ä‘á»ƒ 2600 chuyá»ƒn qua Submarine
    Mon="Skull Slayer"
...
-- SUBMARINE AREA (Ä‘Ăºng má»‘c 2600 / 2625 / 2650 / 2675)
...
local rainbowColors = {
    ...
    Color3.fromRGB(255, 255, 0),  -- vĂ ng
    Color3.fromRGB(0, 255, 0),    -- lá»¥c
    Color3.fromRGB(0, 255, 255),  -- lam
    Color3.fromRGB(0, 0, 255),    -- chĂ m
    Color3.fromRGB(139, 0, 255),  -- tĂ­m
}
...
task.spawn(function()
    ...
    while true do
        ...
        i = (i % #rainbowColors) + 1
        task.wait(0.5) -- thá»i gian Ä‘á»•i mĂ u
    end
end)
...
Tabs.Main:AddSection("Tuáº¥n Anh IOS Äáº¹p Zai Háº¹ Háº¹")
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "Update CĂ y Level 2650-2750 New", Default = false})
    ...
    pcall(function()
        while wait(1) do
            if game:GetService("Workspace").Enemies:FindFirstChild("Tyrant of the Skies") then
                TyrantStatus:SetDesc("âœ…")
            else
                TyrantStatus:SetDesc("âŒ")
            end
        end
    end)
end) 
...
local FarmTyrant = Tabs.Main:AddToggle("FarmTyrant", {Title = "Farm Tyrant + Monster", Description = "Farm QuĂ¡i VĂ  ÄĂ¡nh Boss", Default = false})
...
local FarmPhaBinh = Tabs.Main:AddToggle("FarmPhaBinh", {Title = "Break the Bottle and Summon Boss", Description = "PhĂ¡ BĂ¬nh Triá»‡u Há»“i Boss", Default = false})
