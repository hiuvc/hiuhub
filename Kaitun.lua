...
if queue_on_teleport then
    queue_on_teleport([[
        loadstring(game:HttpGet("https://raw.githubusercontent.com/hiuvc/hiuhub/refs/heads/main/Kaitun.lua"))()
    ]])
end
wait(5)
...
L_1_[15]["Text"] = "Kaitun Blox Fruit "
