...
do
	...
	if (sea == 2753915549) then
		Sea1 = true
	elseif (sea == 4442272183) then
		Sea2 = true
	elseif (sea == 7449423635) then
		Sea3 = true
	else
		game.Players.LocalPlayer:Kick("NOT SUPPORT BLOX KID PLS!")
	end
	------------------------------Anti-AFK----------------------------------------------------------------------------------------------------------------
...
ImageButton.MouseButton1Down:connect(function()
	...
	DropdownSelectWeapon:OnChanged(function(v236)
		ChooseWeapon = v236;
	end)
	task.spawn(function()
		while wait() do
	...
	local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {
        ...
        Description = "",
        Default = false })
    ToggleLevel:OnChanged(function(v237)
        _G.AutoLevel = v237;
        if Value == false then
            wait()
	...
	ToggleBringMob:OnChanged(function(v277)
		 _G.BringMob = v277;
	 end)
