...
local Tabs = {
    Discord = Window:AddTab({Title = "About", Icon = "code-2"}),
    ...
    LP = Window:AddTab({Title = "Local Player", Icon = "baby"}),
    Raid = Window:AddTab({Title = "Raid", Icon = "church"}),
    Race = Window:AddTab({Title = "Race V4", Icon = "clock"}),
    Sea = Window:AddTab({Title = "Sea Event", Icon = "anchor"}),
    Shop = Window:AddTab({Title = "Shop", Icon = "shopping-cart"}),
    Misc = Window:AddTab({Title = "Misc", Icon = "list-plus"}),
    Hop = Window:AddTab({Title = "Hop + Status Server", Icon = "wifi"})
}
    ...
    function CheckLevel()
        ...
        if Third_Sea then
            ...
            elseif Lv == 2525 or Lv <= 2549 or SelectMonster == "Isle Champion" or SelectArea == "Tiki Outpost" then
                ...
                elseif Lv == 2550 or Lv <= 2574 or SelectArea == "Tiki Outpost" then
                Ms = "Serpent Hunter"
                QuestLv = 1
    ...
    spawn(
        ...
        while wait() do
           ...
           if not game.Players.LocalPlayer.Character:FindFirstChild("Highlight") then
                    	...
                    	Highlight.FillColor = Color3.new(100, 100, 100)
	            		Highlight.OutlineColor = Color3.new(100,100,100)
...
ImageButton1.Image = "rbxthumb://type=Asset&id=16060984389&w=420&h=420"
...
ButtonStopButton.Size = UDim2.new(0, 60, 0, 20)
ButtonStopButton.Text = "Stop Tween"
ButtonStopButton.BackgroundColor3 = Color3.fromRGB(30, 20, 20)
ButtonStopButton.BorderSizePixel = 0
ButtonStopButton.Draggable = true
ButtonStopButton.MouseButton1Click:Connect(function()
    ...
    if Third_Sea then
        local ToggleChest =
            Tabs.Main:AddToggle("ToggleChest", {Title = "Auto Chest Stop If Item [Bypass]", Default = false})
    ...
    if Second_Sea then
        local ToggleChest =
            Tabs.Main:AddToggle("ToggleChest", {Title = "Auto Chest Stop If Items [Bypass]", Default = false})
        ToggleChest:OnChanged(
            function(Value)
                _G.chestsea2 = Value
    ...
    spawn(function()
    if _G.chestsea3 or _G.chestsea2 then
    pcall(function()
...
local ToggleSulGuitor = Tabs.Main:AddToggle("ToggleSulGuitor", {Title = "Auto Cake Prince", Default = false})
        ToggleSulGuitor:OnChanged(
            function(Value)
                _G.AutoNevaSoulGuitar = Value
                 StopTween(_G.AutoNevaSoulGuitar)
            end
        )
        Options.ToggleSulGuitor:SetValue(false)
...
_G.soulGuitarhop = false
    ...
    if Third_Sea then
        local RoughSea = Tabs.Sea:AddSection("Kitsune Event")
        ...
        local ToggleTPKitsune =
            Tabs.Sea:AddToggle("ToggleTPKitsune", {Title = "Teleport To Kitsune Island", Default = false})
        ...
        local ToggleCollectAzure =
            Tabs.Sea:AddToggle("ToggleCollectAzure", {Title = "Auto Collect Azure Ambers", Default = false})
    ...
    if Third_Sea then
        ...
        local ToggleSailBoat = Tabs.Sea:AddToggle("ToggleSailBoat", {Title = "Auto Buy Ship + Sail Boat", Default = false})
...
function TPP(CFgo)
	...
	return tweenfunc
        ...
        local ToggleLeviathan = Tabs.Sea:AddToggle("ToggleLeviathan", {Title = "Auto Leviathan", Default = false})

        ToggleLeviathan:OnChanged(
            function(Value)
                _G.AutoLeviathanHaha = Value
                StopTween(_G.AutoLeviathanHaha)
            end
        )
        Options.ToggleLeviathan:SetValue(false)
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Leviathan") then
                        ...
                        AimBotSkillPosition = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, -5, 0)
                                        ...
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until not  _G.AutoLeviathanHaha or not v.Parent or v.Humanoid.Health <= 0
                                    AutoSkill = false
                    Skillaimbot = false
                                end
                            end
...
gg.__namecall = newcclosure(function(...)
    ...
    if Third_Sea then
        ...
        local ToggleAutoW = Tabs.Sea:AddToggle("ToggleAutoW", {Title = "Auto Press W", Default = false})
        ...
        local ToggleTweenMirageIsland =
            Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Teleport To Mirage Island", Default = false})
    ...
    if Third_Sea then
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Tushita [Boss Logma]", Default = false})
...
if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Kill Katakuri V2 [Need Spawn]", Default = false})
    ToggleCakeV2:OnChanged(
        function(Value)
            _G.AutoCakeV2 = Value
            StopTween(_G.AutoCakeV2)
        end
    )
                                    ...
                                    if
                                     ...
                                     then
                                        repeat
                                            ...
                                            if BypassTP then
                                            if
                                        (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - cakepos.Position).Magnitude >
                                            2500
                                     then
                                        BTP(cakepos)
                                    end
...
if Third_Sea then
local NoNameSe = Tabs.Main:AddSection("Admin Boss [Rip_indra True Form]")

local Toggleadminbossfull = Tabs.Main:AddToggle("Toggleadminbossfull", {Title = "Auto Admin Boss [Fully]", Default = false})

Toggleadminbossfull:OnChanged(
    function(Value)
        _G.AdminBossFully = Value
        StopTween(_G.AdminBossFully)
    end
)
Options.Toggleadminbossfull:SetValue(false)

spawn(function()
        pcall(function()
            while wait() do
                if __G.AdminBossFully then
           if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
              ...
              wait(1.2)
              Tween(CFrame.new(-5561.7959, 320.447998, -2663.05566, -0.360997021, -2.28445192e-08, 0.932566941, -8.19995378e-08, 1, -7.2456694e-09, -0.932566941, -7.908573e-08, -0.360997021))
            end
          end
        end
      end)
  end)
local Toggleadminboss = Tabs.Main:AddToggle("Toggleadminboss", {Title = "Auto Kill Admin Boss [Need Spawn]", Default = false})

Toggleadminboss:OnChanged(
    function(Value)
        _G.AutoDarkDagger = Value
        StopTween(_G.AutoDarkDagger)
    end
)
Options.Toggleadminboss:SetValue(false)
...
local AdminPos = CFrame.new(-5344.822265625, 423.98541259766, -2725.0930175781)
    ...
    local Togglespadminboss = Tabs.Main:AddToggle("Togglespadminboss", {Title = "Auto Spawn Admin Boss", Default = false})

Togglespadminboss:OnChanged(
    function(Value)
        Open_Color_Haki = Value
	StopTween(Open_Color_Haki)
    end
)
Options.Togglespadminboss:SetValue(false)
...
spawn(function()
    while wait(.3) do
        pcall(function()
          ...
          local Togglehakidminboss = Tabs.Main:AddToggle("Togglehakidminboss", {Title = "Auto Press Haki [Need Haki Colour]", Default = false})
          Togglehakidminboss:OnChanged(
    function(Value)
        getgenv().OpenHakiColourSpawnAdmin = Value
	StopTween(getgenv().OpenHakiColourSpawnAdmin)
    end
)
Options.Togglehakidminboss:SetValue(false)
    ...
    while wait(.3) do
        pcall(function()
            ...
            if game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or
            	...
            	wait(0.5)
            	repeat Tween(CFrame.new(-5420.16602, 1084.9657, -2666.8208)) wait() 
                until _G.StopTween == true or getgenv().OpenHakiColourSpawnAdmin == false or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-5420.16602, 1084.9657, -2666.8208)).Magnitude <= 10
                wait(0.5)
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("activateColor","Pure Red")
                wait(0.5)
                repeat Tween(CFrame.new(-5414.41357, 309.865753, -2212.45776)) wait() 
                until _G.StopTween == true or getgenv().OpenHakiColourSpawnAdmin == false or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-5414.41357, 309.865753, -2212.45776)).Magnitude <= 10
                wait(0.5)
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("activateColor","Snow White")
                wait(0.5)
                repeat Tween(CFrame.new(-4971.47559, 331.565765, -3720.02954)) wait() 
                until _G.StopTween == true or getgenv().OpenHakiColourSpawnAdmin == false or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-4971.47559, 331.565765, -3720.02954)).Magnitude <= 10
                wait(0.5)
                game:GetService'VirtualUser':Button1Down(Vector2.new(1280,600))
                wait(3)
                game:GetService'VirtualUser':Button1Down(Vector2.new(1280,600))
...
local ToggleRauDen = Tabs.Main:AddToggle("ToggleRauDen", {Title = "Auto Darkbeard Fully", Default = false})

ToggleRauDen:OnChanged(
    function(Value)
        _G.AutoRauDen = Value
		StopTween(_G.AutoRauDen)
    end
)
Options.ToggleRauDen:SetValue(false)
        ...
        pcall(function()
            while wait() do
                if _G.AutoRauDen then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Darkbeard") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == ("Darkbeard") and v.Humanoid.Health > 0 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                                ...
                                until _G.AutoRauDen == false or v.Humanoid.Health <= 0
                            end
                        end
                    else
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - AdminPos.Position).Magnitude > 1500 then
			        print("no bypass tp")
				    elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - RauDenPos.Position).Magnitude < 1500 then
				    Tween(RauDenPos)
					end
				else
				    Tween(RauDenPos)
          ...
          if game.Players.LocalPlayer.Backpack:FindFirstChild("Fist of Darkness") or game.Players.LocalPlayer.Character:FindFirstChild("Fist of Darkness") then
              repeat wait()
                Tween(CFrame.new(3777.04785, 14.6759768, -3499.86719, 0.110488765, -3.50447387e-08, -0.993877351, 1.68704162e-08, 1, -3.33851524e-08, 0.993877351, -1.30784397e-08, 0.110488765))
              EquipTool("Fist of Darkness")
              until
              game:GetService("Workspace").Enemies:FindFirstChild("Darkbeard")
...
local RainbowHakib = Tabs.Main:AddSection("Rainbow Haki")

local ToggleRainbowHaki = Tabs.Main:AddToggle("ToggleRainbowHaki", {Title = "Auto Rainbow Haki", Default = false})

ToggleRainbowHaki:OnChanged(
    function(Value)
        _G.Auto_Rainbow_Haki = Value
		StopTween(_G.Auto_Rainbow_Haki)
    end
)
Options.ToggleRainbowHaki:SetValue(false)
...
local ToggleFastAttackold = Tabs.Setting:AddToggle("ToggleFastAttackold", {Title = " Enable Old Fast Attack", Default = false})

ToggleFastAttackold:OnChanged(
    function(Value)
        _G.FastAttack = Value
    end
)
Options.ToggleFastAttackold:SetValue(false)
...
function FastAttack:ExecuteAttack(target, targetList)
    RegisterAttackEvent:FireServer(_G.Fast_Delay or 0.05)
...
task.spawn(function()
    while task.wait(_G.Fast_Delay or 0.125) do
...
local AttackList = {"0", "0.1", "0.15", "0.155", "0.16", "0.165", "0.17", "0.175", "0.18", "0.185"}
    _G.Fast_Delay = 0.175
    local DropdownDelayAttackvn =
        Tabs.Setting:AddDropdown(
        "DropdownDelayAttackvn",
        {
            Title = "Select Old Fast Attack Delay",
            Values = AttackList,
            Multi = false,
            Default = 1
     })
    DropdownDelayAttackvn:SetValue("0.175")
    DropdownDelayAttackvn:OnChanged(function(Value)
    _G.Fast_Delay = Value
end)
...
spawn(function()
    while wait(.1) do
        if _G.Fast_Delay then
            pcall(function()
                if _G.Fast_Delay == "0" then
                    _G.Fast_Delay = 0
                elseif _G.Fast_Delay == "0.1" then
                    _G.Fast_Delay = 0.1
                elseif _G.Fast_Delay == "0.15" then
                    _G.Fast_Delay = 0.15
                elseif _G.Fast_Delay == "0.155" then
                    _G.Fast_Delay = 0.155
                elseif _G.Fast_Delay == "0.16" then
                    _G.Fast_Delay = 0.16
                elseif _G.Fast_Delay == "0.165" then
                    _G.Fast_Delay = 0.165
                elseif _G.Fast_Delay == "0.17" then
                    _G.Fast_Delay = 0.17
                elseif _G.Fast_Delay == "0.175" then
                    _G.Fast_Delay = 0.175
                elseif _G.Fast_Delay == "0.18" then
                    _G.Fast_Delay = 0.18
                elseif _G.Fast_Delay == "0.185" then
                    _G.Fast_Delay = 0.185
                end
            end)
        end
        ...
        pcall(function()
            for _, v in pairs(workspace.Enemies:GetChildren()) do
                if _G.BringMob and bringmob and v.Name == MonFarm and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                    local dist = (v.HumanoidRootPart.Position - FarmPos.Position).Magnitude
                    local maxDist = (v.Name == "Factory Staff") and 500 or 450
...
local ToggleRemoveNotify =
    Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Remove All Notify [Exp,Level Up...]", Default = false})
...
local ToggleKillPlayer = Tabs.Player:AddToggle("ToggleKillPlayer", {Title = "Auto Kill Player", Default = false })
ToggleKillPlayer:OnChanged(function(Value)
    _G.Auto_Kill_Ply = Value
	
end)

Options.ToggleKillPlayer:SetValue(false)
...
spawn(function()
                        ...
                        if game.Players:FindFirstChild(_G.SelectPly) then
                            if game.Players:FindFirstChild(_G.SelectPly).Character.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    spawn(function()
                                        pcall(function()
                                            if SelectWeapon == SelectWeaponGun then
                                                local args = {
    ...
    local TogglePlayerHun = Tabs.Player:AddToggle("TogglePlayerHun", {Title = "Auto Players Hunter [Not Work]", Default = false })
ToggleKillPlayer:OnChanged(function(Value)
    _G.AutoPlayerHunter = Value
	
end)
Options.TogglePlayerHun:SetValue(false)

local Aimbooti = Tabs.Player:AddSection("Aimbot")
...
spawn(function()
    ...
    local ToggleAimGun = Tabs.Player:AddToggle("ToggleAimGun", {Title = "Aimbot Gun", Default = false })
ToggleAimGun:OnChanged(function(Value)
    _G.Aimbot_Gun = Value
	
end)
Options.ToggleAimGun:SetValue(false)
...
spawn(function()
    ...
    local ToggleAimSkills = Tabs.Player:AddToggle("ToggleAimSkills", {Title = "Aimbot Skills", Default = false })
ToggleAimSkills:OnChanged(function(Value)
...
Options.ToggleAimSkills:SetValue(false)
--------------------------------------------------------------------------------------------------------------------------------------------
...
local Mastery = Tabs.Teleport:AddSection("Travel Island")
...
local ToggleIsland = Tabs.Teleport:AddToggle("ToggleIsland", {Title = "Travel To Island", Default = false})
...
Tabs.Race:AddButton(
    {
        ...
        Description = "Function Only Third Sea",
        Callback = function()
...
Tabs.Race:AddButton(
    {
        Title = "Disabled Infinite Stairs",
        Description = "Function Only Third Sea",
        Callback = function()
...
local ToggleBuyGears = Tabs.Race:AddToggle("ToggleBuyGears", {Title = "Auto Buy Gear", Default = false})
ToggleBuyGears:OnChanged(
    function(Value)
...
Options.ToggleBuyGears:SetValue(false)
local Mastery = Tabs.Race:AddSection("Auto Race")

Tabs.Race:AddButton(
    {
        Title = "Teleport To Your Race Door",
        Description = "Function Only Third Sea",
        Callback = function()
            Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Quest Trial ", Default = false})
...
local ToggleKillPlye = Tabs.Race:AddToggle("ToggleKillPlye", {Title = "Auto Kill Players | 100% Win", Default = false})
ToggleKillPlye:OnChanged(
    function(Value)
...
Options.ToggleKillPlye:SetValue(false)
...
Tabs.Shop:AddButton(
    {
        Title = "Superhuman",
        Description = "V1 Fighting Styles",
        Callback = function()
...
local Mastery = Tabs.Shop:AddSection("Fragment")
...
Tabs.Misc:AddButton(
    {
        Title = "Rain Fruit",
        Description = "Rain fruit [Cannot Eat, Fake]",
        Callback = function()
...
Tabs.Misc:AddButton(
    {
        Title = "Show Items",
        Description = "If You Turn On It,You Cannot Turn Off It",
        Callback = function()
            do
...
Tabs.Misc:AddButton(
    {
        Title = "Always Day",
        Description = "Game Never Has Night",
        Callback = function()
            game:GetService("RunService").Heartbeat:wait()
            do
...
local GroupNoo= Tabs.Misc:AddSection("Graphics")

    Tabs.Misc:AddButton(
        {
            Title = "Fps Boost",
            Description = "Booster Your Fps,Remove All To Boost",
            Callback = function()
                FPSBooster()
            end
        }
            ...
            "StrawHatMaine",
              "Sub2OfficialNoobie",
                "SUB2NOOBMASTER123",
                  ...
                  local DropdownCoders =
    Tabs.Misc:AddDropdown(
    "DropdownCoders",
    {
        Title = "Select Code To Reddem",
        Values = CodeListO,
        Multi = false,
        Default = 1
    }
...
DropdownCoders:SetValue("Sub2Fer999")
DropdownCoders:OnChanged(
    function(Value)
        _G.SelectCodees = Value
    end
)

Tabs.Misc:AddButton(
        {
            Title = "Redeem Code Selected",
            Description = "Redeem Code Selected Above",
            Callback = function()
                game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.SelectCodees)
            end
        }
    )
...
local StatusSv = Tabs.Hop:AddSection("Status Server")

Tabs.Hop:AddParagraph({
        Title = "Bug",
        Content = "Status Is Having Bug Can't Update New Values Wait Fix!"
  })
    ...
    Tabs.Hop:AddParagraph({
        Title = "Full Moon",
        Content = "Server Time : " .. function8() .. " | ".. CheckMoon() .. " | " .. function7()
  })
    
    
    Tabs.Hop:AddParagraph({
        Title = "Ancient One",
        Content = "Anclient One Status : " .. tostring(CheckAcientOneStatus())
        
      
  })
  
  function CheckElite()
  if Second_Sea or First_Sea then
  ...
  Tabs.Hop:AddParagraph({
        Title = "Elite",
        Content = "Elite : "..tostring(CheckElite())
})
...
function CheckHaki()
  ...
  if game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("ColorsDealer", "1") then
    return "Haki Colour : "..KuyKoben
  else
    return "Haki Colour : Not Found"
  end
  end

    Tabs.Hop:AddParagraph({
        Title = "Haki Colour Check",
        Content = tostring(CheckHaki())
})
    

function CheckSwordLegendary()
if First_Sea or Third_Sea then
    return "Only Second Sea"
  end
  ...
  if Second_Sea then
    ...
    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer", "1") then
      return "Shisui"
    elseif
      game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer","2") then
      return "Wando"
    elseif
...
Tabs.Hop:AddParagraph({
        Title = "Legendary Sword Check",
        Content = "Legendary Sword : "..tostring(CheckSwordLegendary())
})
...
Tabs.Hop:AddParagraph({
        ...
        Content = "Mirage Island : "..tostring(MirageChecker())
})
...
Tabs.Hop:AddParagraph({
        Title = "Kitsune Island Check",
        Content = "Kitsune Island : "..tostring(kitChecker())
})

local LPv = Tabs.LP:AddSection("Local Player")

Tabs.LP:AddParagraph({
        Title = "Anti Ban + Anti Afk",
        Content = "They Ran When You Executed The Script!"
})



    local ToggleAutoHaki = Tabs.LP:AddToggle("ToggleAutoHaki", {Title = "Auto Haki", Default = true})
    ToggleAutoHaki:OnChanged(
        function(Value)
            _G.AUTOHAKI = Value
        end
    )
    ...
    local ToggleKenHakiTurnon = Tabs.LP:AddToggle("ToggleKenHakiTurnon", {Title = "Auto Enabled Observation Haki", Default = false})
    ToggleKenHakiTurnon:OnChanged(
        function(Value)
            _G.AutoTurnOnObservation = Value
        end
    )
    Options.ToggleKenHakiTurnon:SetValue(false)
...
local ToggleTurnOnRaceV3 = Tabs.LP:AddToggle("ToggleTurnOnRaceV3", {Title = "Auto Turn On Race V3", Default = false})
ToggleTurnOnRaceV3:OnChanged(
    function(Value)
        _G.V3 = Value
    end
)
Options.ToggleTurnOnRaceV3:SetValue(false)
...
local ToggleTurnOnRaceV4 = Tabs.LP:AddToggle("ToggleTurnOnRaceV4", {Title = "Auto Turn On Race V4", Default = false})
ToggleTurnOnRaceV4:OnChanged(
    function(Value)
        _G.V4 = Value
    end
)

Options.ToggleTurnOnRaceV4:SetValue(false)
...
local ToggleEnbPVP = Tabs.LP:AddToggle("ToggleEnbPVP", {Title = "Auto Enabled Pvp", Default = false })
ToggleEnbPVP:OnChanged(function(Value)
    _G.EnabledPvP = Value
end)
...
Options.ToggleEnbPVP:SetValue(false)



local ToggleNooLip = Tabs.LP:AddToggle("ToggleNooLip", {Title = "No Clip", Default = false})
ToggleNooLip:OnChanged(
    function(Value)
        _G.NOCLIP = Value
    end
)

Options.ToggleNooLip:SetValue(false)
...
local ToggleWalkOnWader = Tabs.LP:AddToggle("ToggleWalkOnWader", {Title = "Walk On Water", Default = true})
ToggleWalkOnWader:OnChanged(
    function(Value)
        _G.WalkWater = Value
    end
)

Options.ToggleWalkOnWader:SetValue(true)
spawn(function()
    while task.wait() do
        pcall(function()
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Speed = NumberRange.new(40, 40)
...
local ToggleSpeedHack = Tabs.LP:AddToggle("ToggleSpeedHack", {Title = "Speed Hack", Default = true})
ToggleSpeedHack:OnChanged(
    function(Value)
        _G.SpeedHack = Value
        InfAbility()
    end
...
Fluent:Notify({
    Title = "Skibidi Hub",
    Content = "Join My Discord For New Notify!",
    Duration = 8
})
