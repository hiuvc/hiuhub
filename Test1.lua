...
function Library:NewWindow(ConfigWindow)
	...
	Close.MouseButton1Down:Connect(function()
		...
		tat_["BackgroundColor3"] = Color3.fromRGB(20, 20, 25);
		...
		btnyes["BackgroundColor3"] = Color3.fromRGB(40, 40, 45);
		...
		btnno["BackgroundColor3"] = Color3.fromRGB(40, 40, 45);
	...
	-- Flatten the top/right corners of TabFrame so it blends with the main frame if needed, 
	-- but here we might just let it be a sidebar. 
	-- Let's stick to the structure.

	Line_2.Name = "Line"
	Line_2.Parent = TabFrame
	Line_2.BackgroundColor3 = Color3.fromRGB(45, 45, 50)
	...
	LayoutFrame.Position = UDim2.new(0, 150, 0, 50)
	LayoutFrame.Size = UDim2.new(1, -150, 1, -50)
	...
	function Tab:T(t)
		...
		Choose_2.BackgroundColor3 = Color3.fromRGB(138, 43, 226)
		...
		NameTab_2.Text = t
		NameTab_2.TextColor3 = Color3.fromRGB(240, 240, 240)
		...
		function TabFunc:AddSection(RealNameSection)
			...
			UIStroke_2.Color = Color3.fromRGB(60, 60, 70)
			...
			UIGradient.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 20, 25)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(138, 43, 226)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 20, 25)) }
			...
			function SectionFunc:AddToggle(cftoggle)
				...
				Check.Position = UDim2.new(0, 2, 0.5, 0)
				...
				function ToggleFunc:Set(Boolean)
					if Boolean then
						Library:TweenInstance(ToggleCheck, 0.3, "BackgroundColor3", Color3.fromRGB(138, 43, 226))
						...
						Library:TweenInstance(ToggleCheck, 0.3, "BackgroundColor3", Color3.fromRGB(40, 40, 45))
						Library:TweenInstance(Check, 0.3, "BackgroundColor3", Color3.fromRGB(150, 150, 150))
						Library:TweenInstance(Check, 0.3, "Position", UDim2.new(0, 2, 0.5, 0))
					end
					self.Value = Boolean
			...
			function SectionFunc:AddDropdown(cfdropdown)
				...
				UIStroke_3.Color = Color3.fromRGB(60, 60, 70)
				...
				function DropFunc:Add(v)
					...
					UIGradient_3.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(138, 43, 226)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) }
			...
			function SectionFunc:AddInput(cftextbox)
				...
				TextboxFrame.Size = UDim2.new(0, 130, 0, 30)
			...
			function SectionFunc:AddSlider(cfslider)
				...
				SliderFrame.Size = UDim2.new(0, 130, 0, 4)
				...
				SliderDraggable.BackgroundColor3 = Color3.fromRGB(138, 43, 226)
			...
			function SectionFunc:AddParagraph(cfpara)
				...
				Paragraph.BackgroundColor3 = Color3.fromRGB(24, 24, 28)
	...
	G2L["4"]["Thickness"] = 2;
	G2L["4"]["Color"] = Color3.fromRGB(138, 43, 226);
